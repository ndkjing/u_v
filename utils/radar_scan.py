...
class PaintArea(QWidget):
    ...
    def paintEvent(self, QPaintEvent, b_first=True):
        ...
        if self.shape == "Line":
            ...
            self.theta %= 360
            if 0 <= theta < 90:
                point2 = QPoint(200 + int(150 * math.sin(theta)), 200 - int(150 * math.cos(theta)))
            elif 90 <= theta < 180:
                point2 = QPoint(200 + int(150 * math.cos(theta - 90)), 200 + int(150 * math.sin(theta - 90)))
            elif 180 <= theta < 270:
                point2 = QPoint(200 - int(150 * math.sin(theta - 180)), 200 + int(150 * math.cos(theta - 180)))
            else:
                point2 = QPoint(200 - int(150 * math.cos(theta - 270)), 200 - int(150 * math.sin(theta - 270)))
            print('update_point', point2)
            p.drawLine(point1, point2)
            # 绘制障碍物
            points1 = [QPoint(300, 200), QPoint(320, 180), QPoint(280, 160), QPoint(250, 190)]
            p.drawPolygon(QPolygon(points1), Qt.WindingFill)
            points2 = [QPoint(180, 220), QPoint(170, 230), QPoint(190, 225), QPoint(175, 215)]
            p.drawPolygon(QPolygon(points2), Qt.WindingFill)
            # p.drawLine(QPoint(200,200), QPoint(200,50))
